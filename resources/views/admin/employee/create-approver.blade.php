@extends('template.template', ['title' => 'Create Approver', 'is_active' => true])
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card p-3">
            ...
            <form action="{{ route('employee.approver.store', $employee->id) }}" method="post" enctype="multipart/form-data">
                @csrf
